...
public class ConsoleServlet extends HttpServlet {
	...
	ObjectModel oModel = new ObjectModel(null, 0, false);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//TODO
		//This is the intro text, get it to display at the start of the game.
		result = "Last night you received an urgent call from your buddy Kevin, aka The Raft Wizard \n "
				+ "Kevin warned you about an incoming flood that's going to devastate the land, "
				+ "and urged you to meet him at his dungeon to help him find his lost raft. \n"
				+ "As you and Kevin entered the dungeon, you were ambushed by a monster and separeted from your friend \n"
				+ "You got lost in the dungeon and passed out from exhaustion. \n"
				+ "You wake up the next morning determined to find your friend, get that raft, and get to saftey before you drown in the flood."
				+ "/n But time is running out...";
		
		//TODO
		//Whenever the player enters a new room, check if the room has been discovered yet
		//If not, set discovered to true and give the player 10 points
					...
					if (secondW.toLowerCase().compareTo("chest") == 0) {
						...
						for (int i = 0; i < pModel.getInvenFULL().length; i++) {
							if (pModel.getInventory(i) != null) {
								//Checks if the player has the key by checking the name of the item.
								if (pModel.getInventory(i).getName() == "Key") {
									tempr = true;
								}
							}
						}
						if (tempr) {
							if (currentR.checkInven("Chest")) {
								// !!!!!!!!!!!!!!!!!!
								//
